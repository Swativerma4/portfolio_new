    ...
    <div className='home__data'>
      <div className='home__title'>
        ...
        <p className='home__description'>
          I'm a passionate React developer with expertise in JavaScript and building efficient, user-friendly interfaces.
        </p>
        <a href="#contact" className='btn btn-primary-1'>
          <span>Say Hello</span>
          <svg
